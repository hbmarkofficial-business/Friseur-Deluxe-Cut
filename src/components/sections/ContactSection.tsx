          ...
          <AnimateOnScroll animation="slide-right">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Button variant="goldOutline" size="xl" asChild>
                <a href="tel:01775950376">Jetzt anrufen</a>
              </Button>
            </div>
          </AnimateOnScroll>
          ...
          <AnimateOnScroll animation="slide-left">
            <div className="relative">
              <div className="aspect-square lg:aspect-[4/5] rounded-sm overflow-hidden border border-border">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d19878.17701987166!2d7.0974023743164!3d51.480696900000034!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47b8e1b046e2f239%3A0x91f1e3072be4ec2f!2sFriseur%20Deluxe%20Cut%20-%20Bochum!5e0!3m2!1sde!2sde!4v1771714667142!5m2!1sde!2sde"
                  width="100%"
                  height="100%"
